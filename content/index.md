...
<div id="p5-canvas-container" style="width: 100%; height: 60vh; position: relative; margin-bottom: 1rem;">
    </div>
...
<script>
  ...
  // Find the setup function in your swirl-pattern.js and modify the createCanvas line:
  /*
  // Inside setup() in swirl-pattern.js:
  let canvasContainer = document.getElementById('p5-canvas-container');
  // Make canvas responsive within the container
  ...
  // Also modify windowResized in swirl-pattern.js:
  ...
  */
  // You will need to make the above edits inside your swirl-pattern.js file.
  // The comments explain where to put the code.
</script>
